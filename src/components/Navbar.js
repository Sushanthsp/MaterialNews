...
export default function Navbar(props) {
  ...
  return (
    <>
      <AppBar sx={{ backgroundColor: "#077DFA",position: 'relative' }}>
        <Toolbar>
          <NewspaperIcon />
            ...
            <> 
              ...
              >
                {pages.map((page, index) => (
                  <Tab key={index} label={page.category} component={Link} 
                  to={page.link}   />
                ))} 
              </Tabs>
